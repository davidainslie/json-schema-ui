...
(function(angular) {
    ...
    InputValidator.prototype.showErrors = function(isSubmit) {
        ...
        if (!ngModel.$valid) {
            ...
            // DA 19th May 2014 - If a form is split over multiple "pages", we don't want "error class" upon an intial "page" load.
            if (this.ngModel.$dirty && this.ngModel.$invalid) {
                // DA 19th May 2014 - Radio's parents are marked with "xt-error"
        ...
        .directive('xtValidate', function() {
            return {
                ...
                link: function(scope, element, attrs, ctrls) {
                    ...
                    element.on('$destroy', function() {
                        // DA 16th May 2014 - added the following "if" to avoid a null pointer exception and hence a possible issue with what is rendered in browser.
                        if (xtFormCtrl.validators) {
